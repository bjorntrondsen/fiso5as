namespace :matches do
  ...
  task :create => :environment  do
    ActiveRecord::Base.transaction do
      ...
      away_team = Team.create!(fpl_id: 11025, name: "Assassins")
      away1 = away_team.managers.create!(fpl_id: 48864, fiso_name: 'travatron')
      away2 = away_team.managers.create!(fpl_id: 31670, fiso_name: 'Bridewater')
      away3 = away_team.managers.create!(fpl_id: 52214, fiso_name: 'Doset Hammer')
      away4 = away_team.managers.create!(fpl_id: 32669, fiso_name: 'Tenpinterry')
      away5 = away_team.managers.create!(fpl_id: 10330, fiso_name: 'Ardvark')

      starts_at = Time.parse("2014/12/06 11:45")
      ends_at   = Time.parse("2014/12/09 04:00")
      game_week = 15
