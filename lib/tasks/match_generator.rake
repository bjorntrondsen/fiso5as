namespace :matches do
  ...
  task :create => :environment  do
    ActiveRecord::Base.transaction do
      ...
      home1 = home_team.managers.find_by(fiso_name: 'Wahl84')
      ...
      away_team = Team.create!(fpl_id: 204722, name: "Rejects")
      away1 = away_team.managers.create!(fpl_id: 290086, fiso_name: 'gjkendall')
      away2 = away_team.managers.create!(fpl_id: 3456, fiso_name: 'f_dzilla')
      away3 = away_team.managers.create!(fpl_id: 128096, fiso_name: 'RichH6109')
      away4 = away_team.managers.create!(fpl_id: 16355, fiso_name: 'GM')
      away5 = away_team.managers.create!(fpl_id: 208543, fiso_name: 'jaweathers')

      starts_at = Time.parse("2014/08/23 11:45")
      ends_at = Time.parse("2014/08/26 04:00")
      game_week = 2
