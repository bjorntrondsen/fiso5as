namespace :matches do
  ...
  task :create => :environment  do
    ActiveRecord::Base.transaction do
      ...
      away_team = Team.create!(fpl_id: 220120, name: "Barmy Army")
      away1 = away_team.managers.create!(fpl_id: 266890, fiso_name: 'juan pablo')
      away2 = away_team.managers.create!(fpl_id: 721723, fiso_name: 'kris fiso')
      away3 = away_team.managers.create!(fpl_id: 237749, fiso_name: 'owenclass')
      away4 = away_team.managers.create!(fpl_id: 59460, fiso_name: "mr john123")
      away5 = away_team.managers.create!(fpl_id: 953760, fiso_name: 'draughton')

      starts_at = Time.parse("2014/02/11 11:45")
      ends_at = Time.parse("2014/02/13 04:00")
      game_week = 26
