namespace :matches do
  ...
  task :create => :environment  do
    ActiveRecord::Base.transaction do
      ...
      away_team = Team.create!(fpl_id: 75895, name: "Terminators")
      away1 = away_team.managers.create!(fpl_id: 884, fiso_name: 'blessedbrian')
      away2 = away_team.managers.create!(fpl_id: 46045, fiso_name: 'Libero')
      away3 = away_team.managers.create!(fpl_id: 247546, fiso_name: 'Malrom')
      away4 = away_team.managers.create!(fpl_id: 132090, fiso_name: "Mick MacPaddywack")
      away5 = away_team.managers.create!(fpl_id: 5070, fiso_name: 'Surprised')

      starts_at = Time.parse("2013/12/21 11:45")
      ends_at = Time.parse("2013/12/24 04:00")
      game_week = 17
