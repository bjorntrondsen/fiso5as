namespace :matches do
  ...
  task :create => :environment  do
    ActiveRecord::Base.transaction do
      ...
      away4 = away_team.managers.create!(fpl_id: 161358, fiso_name: 'Bluenosey')
      away5 = away_team.managers.create!(fpl_id: 159950, fiso_name: 'Slowfish')

      starts_at = Time.parse("2015/01/31 11:45")
      ends_at   = Time.parse("2015/02/02 04:00")
      game_week = 23
