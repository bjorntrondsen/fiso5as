namespace :matches do
  ...
  task :create => :environment  do
    ActiveRecord::Base.transaction do
      ...
      away_team = Team.create!(fpl_id: 11649, name: "Golden Boots")
      away1 = away_team.managers.create!(fpl_id: 8666, fiso_name: 'minigoku')
      away2 = away_team.managers.create!(fpl_id: 37891, fiso_name: 'jn77')
      away3 = away_team.managers.create!(fpl_id: 2359, fiso_name: 'messienaar')
      away4 = away_team.managers.create!(fpl_id: 3723, fiso_name: 'Cartral')
      away5 = away_team.managers.create!(fpl_id: 336934, fiso_name: 'Wozzer')

      starts_at = Time.parse("2014/05/03 11:45")
      ends_at = Time.parse("2014/05/08 04:00")
      game_week = 37
