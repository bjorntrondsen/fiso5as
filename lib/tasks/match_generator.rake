namespace :matches do
  ...
  task :create => :environment  do
    ActiveRecord::Base.transaction do
      ...
      away1 = away_team.managers.create!(fpl_id: 9624, fiso_name: 'AstonTinCanDribblers')
      away2 = away_team.managers.create!(fpl_id: 1818, fiso_name: 'Nulli Secunda')
      away3 = away_team.managers.create!(fpl_id: 107399, fiso_name: 'No Ruddy Points')
      away4 = away_team.managers.create!(fpl_id: 19558, fiso_name: 'topcats strollers')
      away5 = away_team.managers.create!(fpl_id: 218402, fiso_name: 'Your Mum\'s Athletic')
