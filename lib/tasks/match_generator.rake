namespace :matches do
  ...
  task :create => :environment  do
    ActiveRecord::Base.transaction do
      ...
      home5 = home_team.managers.create(fpl_id: 1419578, fiso_name: 'Bluenosey')

      away_team = Team.create!(fpl_id: 264522, name: "Dark Horses")
      away1 = away_team.managers.create!(fpl_id: 342216, fiso_name: 'Fil16')
      away2 = away_team.managers.create!(fpl_id: 91457, fiso_name: 'Dazbowski')
      away3 = away_team.managers.create!(fpl_id: 13818, fiso_name: 'Gazwood')
      away4 = away_team.managers.create!(fpl_id: 88147, fiso_name: 'Bloufo')
      away5 = away_team.managers.create!(fpl_id: 104407, fiso_name: 'Golden Bear')

      starts_at = Time.parse("2014/03/15 11:45")
      ends_at = Time.parse("2014/03/17 04:00")
      game_week = 30
