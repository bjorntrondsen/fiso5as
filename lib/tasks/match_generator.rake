namespace :matches do
  ...
  task :create => :environment  do
    ActiveRecord::Base.transaction do
      ...
      away_team = Team.create!(fpl_id: 116426, name: "Predators")
      away1 = away_team.managers.create!(fpl_id: 18686, fiso_name: 'Topcat24')
      away2 = away_team.managers.create!(fpl_id: 60724, fiso_name: 'Spinynorman')
      away3 = away_team.managers.create!(fpl_id: 223302, fiso_name: 'Bristolciteh')
      away4 = away_team.managers.create!(fpl_id: 777, fiso_name: 'Calvin1979')
      away5 = away_team.managers.create!(fpl_id: 584807, fiso_name: 'Toffeelover')

      starts_at = Time.parse("2014/08/15 11:45")
      ends_at = Time.parse("2014/05/19 04:00")
      game_week = 1
