namespace :matches do
  ...
  task :create => :environment  do
    ActiveRecord::Base.transaction do
      ...
      home4 = home_team.managers.find_by(fiso_name: 'OatFedGoat')
      home5 = home_team.managers.find_by(fiso_name: 'Sharagoz')

      away_team = Team.create!(fpl_id: 269410, name: "Terminator")
      away1 = away_team.managers.create!(fpl_id: 146798, fiso_name: 'Mick MacPaddywack')
      away2 = away_team.managers.create!(fpl_id: 63654, fiso_name: 'Libero')
      away3 = away_team.managers.create!(fpl_id: 135011, fiso_name: 'Surprised')
      away4 = away_team.managers.create!(fpl_id: 6866, fiso_name: 'Malrom')
      away5 = away_team.managers.create!(fpl_id: 43070, fiso_name: 'MoSe')

      starts_at = Time.parse("2015/09/19 11:45")
      ends_at   = Time.parse("2015/09/22 04:00")
      game_week = 6
